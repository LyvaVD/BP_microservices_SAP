...
\begin{figure}[h]
	\includegraphics[width=5cm]{orderfullfilment.jpg}
...
\begin{figure}[h]
	\includegraphics[width=5cm]{ordershipment.jpg}
...
\begin{figure}[h]
	\includegraphics[width=10cm]{apiSchema.jpg}
