...
Onder volgende deeltjes wordt er dieper ingegaan op de authenticatie en authorisatie, het verband met Agile en Devops en de bescherming van microservices.
...
\begin{table}[]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|p{2cm}|p{10cm}|p{10cm}|p{10cm}|}
				\hline 
				 & Local authentication and auhtorization
				 & Global authentication and authorization\\ \hline	
			Wat
				& Een microservice is verantwoordelijk voor de authenticatie en de authorisatie.
				& Toegang tot alles of tot niks. \\ \hline
			Voordelen
				& Verschillende authenticatie mechanismen kunnen geimplementeerd worden voor elke microservice apart.
				& De authenticatie en authorisatie wordt maar op één plek toegepast dus er is geen gedupliceerde code.\\ \hline
			Nadelen
				& De code wordt druk en veel. De code kan gedupliceerd worden wat zorgt bij het maken van aanpassingen moet er op veel plaatsen aangepast worden.
				& De microservices hebben geen controle over wat de gebruiker kan doen. Bij falen, stopt alles met werken\\ \hline	
		\end{tabular}%
	}
	\caption{De voordelen en nadelen van authentication en authorization, \textcite{Aggarwal2019}}
\end{table}
...
\begin{table}[]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|p{10cm}|}
			\hline 
			 Global authentication and authorizatie 
			 	& Dit wordt gebruikt wanneer de front-end de volledige authenticatie op zich neemt. Dan neemt de back-end enkel de authorizatie op zich. \\ \hline
			Global authentication and service authorizatie
				& Hier wordt de authenticatie ook in de front-end gehouden. De front-end spreekt de back-end aan om dan de authorizatie af te handelen. \\ \hline
			Service authentication and global authorizatie
				& Authorizatie komt nooit voor authenticatie. \\ \hline
			Service authentication and authorizatie 
				& Dit is een optie maar het is niet aan te raden in een gelaagde architectuur. Het is moeilijk om dan globaal de authenticatie te onderhouden. Eens er moet gescaled worden, is het beter om zulke services apart te houden. \\ \hline				
		\end{tabular}%
	}
	\caption{De verschillende combinaties tussen authenticatie en authorizatie, \textcite{Douglass2018}}
\end{table}
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|p{2cm}|p{10cm}|p{10cm}|p{10cm}|}
			...
			Nadelen
				...
				& Omdat dit een single point of entry kan dit een bottleneck, een plek van opstopping, zijn in de architectuur. \\ \hline
			Doel 
				& /
				& / \\ \hline
...
Enkele tips om de bescherming van microservices aan te pakken, \textcite{Matteson2017}:
\begin{itemize}
...
\subsubsection{Het debuggen en troubleshooten bij microservices}
